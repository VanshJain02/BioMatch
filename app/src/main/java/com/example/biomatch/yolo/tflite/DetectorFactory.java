package com.example.biomatch.yolo.tflite;
...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        if (modelFilename.equals("finger_detect.tflite")) {
            labelFilename = "file:///android_asset/customclasses__.txt";
            isQuantized = false;
            inputSize = 416;
        ...
        else if (modelFilename.equals("best-fp16_fingtype.tflite")) {
            labelFilename = "file:///android_asset/customclasses__.txt";
            isQuantized = false;
            inputSize = 416;
            output_width = new int[]{40, 20, 10};
